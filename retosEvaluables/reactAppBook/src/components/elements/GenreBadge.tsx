...
const genreColors: { [key: string]: { colorLight: string; colorDark: string } } = {
    "Ficción": {
 ...
 const colors = genreColors[genre] || { colorLight: "#7C7C7C", colorDark: "#A0A0A0" };
  const backgroundColor = theme === 'dark' ? colors.colorDark : colors.colorLight;
